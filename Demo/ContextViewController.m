...
- (void)viewDidLoad {
    ...
    test1 = [[TestViewController alloc] initWithController:self];
    ...
    test2 = [[TestViewController alloc] initWithController:self];
    ...
    test3 = [[TestViewController alloc] initWithController:self];
    ...
    test4 = [[TestViewController alloc] initWithController:self];
...
-(void)bottomTapGesture:(UITapGestureRecognizer *)gesture
{
    [UIView animateWithDuration:0.25 animations:^{
        if(_scrollType == NormalScrollView){
            ...
            _scrollType = FullBottomScrollView;
        }else{
