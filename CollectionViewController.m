...
//    self.collectionViewLayout.itemSize = (CGSize){SCREEN_WIDTH, SCREEN_HEIGHT - 69.0f - 44.0f -49};
    self.collectionViewLayout.itemSize = (CGSize){[UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 69.0f - 44.0f -28};



    [self.collectionView setPagingEnabled:YES];  //视图整页显示
    [self.collectionView setBounces:NO]; //避免弹跳效果,避免把根视图露出来
